...
const tokenService = new TokenService(new TokenRepository(), new UserRepository(), new CryptoService(), config, jwt.sign);
export const authService = new AuthService(new UserRepository(), new PasswordService(), tokenService);
